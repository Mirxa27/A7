...
const callHuggingFace = async (prompt, systemInstruction, settings) => {
...
export const callOpenAI = async (prompt, systemInstruction, settings) => {
 ...
 */
export const executeIterativeResearch = async (goal, rounds = 3) => {
    const researchLog = [];
    const allSources = [];
    let currentFactBase = "";
...
export const testAIConnection = async (testSettings) => {
    try {
...
export const analyzeIntel = async (text, realOsintContext) => {
...
export const generatePersona = async (targetWeakness) => {
...
export const generateBehavioralForecast = async (targetData) => {
...
export const generateTacticalAsset = async () => {
...
export const generateTargetDossier = async (query, resources = [], realOsintData) => {
...
export const generateMissionPlan = async (targetName, details, objective) => {
...
- INTEL SUMMARY: ${details.substring(0, 1000)}...`,
        ...
        return { targetName, objective, ...result };
    }
    catch (error) {
...
export const analyzeForensicArtifact = async (metadata) => {
...
export const generateExfiltrationArtifacts = async (targetName, dossier) => {
